...
let EmailsController = class EmailsController {
  constructor(connection) {
    this.repository = connection.getRepository(email_entity_1.default);
  }
  async findAll(req) {
...
__decorate(
  [
    ...
    openapi.ApiResponse({
      status: 200,
      type: [require('../entities/email.entity').default],
    }),
...
__decorate(
  [
    ...
    __metadata('design:type', Function),
    __metadata('design:paramtypes', [email_entity_1.default]),
    __metadata('design:returntype', Promise),
  ],
  EmailsController.prototype,
  'create',
...
exports.EmailsController = EmailsController = __decorate(
  [
    ...
    (0, swagger_1.ApiTags)('Crm Emails'),
    (0, common_1.Controller)('api/crm/emails'),
