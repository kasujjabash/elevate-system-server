...
exports.submissionGenerators = void 0;
...
const generateServiceSubmission = (
  ...
  const totalAttendance = 150 + Math.floor(Math.random() * 200);
  ...
  return {
    ...
    data: {
      ...
      offering: Math.floor(500000 + Math.random() * 1500000),
      sermonTopic: [
        'Walking in Faith',
        'The Power of Prayer',
        'Living with Purpose',
...
//# sourceMappingURL=seed-submissions.js.map
