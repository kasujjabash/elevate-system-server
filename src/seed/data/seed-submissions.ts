...
const generateMCSubmission = (fellowshipId: number, fellowshipName: string, memberCount: number, weeksAgo: number, submittedBy: any) => {
...
const generateServiceSubmission = (locationId: number, locationName: string, weeksAgo: number, submittedBy: any) => {
